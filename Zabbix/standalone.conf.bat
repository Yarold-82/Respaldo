...
rem # 
rem # set "JAVA_OPTS=%JAVA_OPTS% -javaagent:D:\wildfly-26.1.3.Final\apm\elastic-apm-agent-1.50.0.jar"
rem # set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.service_name=MiServicioWildFly"
rem # set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.server_urls=http://localhost:8200"
rem # set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.environment=produccion"
rem # set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.application_packages=service"



rem Ensure existing JAVA_OPTS are preserved
set "JAVA_OPTS=%JAVA_OPTS% -javaagent:D:\wildfly-26.1.3.Final\apm\elastic-apm-agent-1.50.0.jar"
set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.service_name=MiServicioWildFly"
set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.server_urls=http://127.0.0.1:8200"
set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.environment=produccion"
set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.application_packages=service"
set "JAVA_OPTS=%JAVA_OPTS% -Delastic.apm.log_level=DEBUG"
rem Optional: you can add more JAVA_OPTS below as needed
set "JAVA_OPTS=%JAVA_OPTS% -Xms1024m -Xmx2048m -XX:MetaspaceSize=256m -XX:MaxMetaspaceSize=512m"


rem Call the original standalone.bat
call "%~dp0standalone.bat" %*
...
rem set "JAVA_OPTS=%JAVA_OPTS% -Dnet.bytebuddy.experimental=true"Sample
...
rem # Ruta de APM visualizador de Java
rem #         error_log /var/log/nginx/wsnestle.error.log;